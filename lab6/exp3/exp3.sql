...
CREATE EXTERNAL TABLE curtis.iptrace  (time string, id bigint, src string, bracket string, dest string, protocol string, port string) ROW FORMAT DELIMITED FIELDS TERMINATED BY ' ' LOCATION '/users/curtisu/Lab6/Exp3/ip_trace';
