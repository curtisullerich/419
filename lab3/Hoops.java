 ...
 */
public class Hoops extends Configured implements Tool {
	
	public static void main ( String[] args ) throws Exception {
		
		int res = ToolRunner.run(new Configuration(), new Hoops(), args);
		System.exit(res); 
	...
	public int run ( String[] args ) throws Exception {
		...
		// Create the job
		Job job_one = new Job(conf, "Hoops Program Round One"); 
		
		// Attach the job to this Bigrams
		job_one.setJarByClass(Hoops.class); 
		...
		Job job_two = new Job(conf, "Hoops Program Round Two"); 
		job_two.setJarByClass(Hoops.class);
		...
		Job job_three = new Job(conf, "Hoops Program Round Three");
		job_three.setJarByClass(Hoops.class);
